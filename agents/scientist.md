...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - Report saved to `.oh-my-cursor/scientist/reports/` with visualizations in `.oh-my-cursor/scientist/figures/`
  </Success_Criteria>
  ...
  <Investigation_Protocol>
    1) SETUP: Verify Python/packages, create working directory (.oh-my-cursor/scientist/), identify data files, state [OBJECTIVE].
  ...
  <Output_Format>
    ...
    Report saved to: .oh-my-cursor/scientist/reports/{timestamp}_report.md
  </Output_Format>
